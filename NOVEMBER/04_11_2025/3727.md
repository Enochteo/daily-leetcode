...
Handles negative numbers correctly via abs sorting.

Works for odd or even number of elements.

**Pattern to Remember**

This uses the Two-Pointer Accumulation Pattern:

Move inward from both ends simultaneously.

Perform symmetric operations each iteration.
