...
Space Complexity: O(n) for storing all elements and their tracked mins.

**Pattern to Remember**

This follows the Monotonic Stack / Dual Stack Pattern:

Use one stack for values, one for metadata (e.g., minimums or maximums).
