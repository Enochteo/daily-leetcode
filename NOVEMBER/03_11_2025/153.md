...
This follows the Binary Search on Rotated Array / Pivot Detection pattern:

Compare mid with right (or left) boundary to find the sorted half.

Narrow down to the unsorted region (where the rotation pivot lies).
